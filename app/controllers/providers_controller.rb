	...
	private
		...
		def provider_params
			params.require(:provider). permit(:name, :npi, :specialty, :specialty_id, :image, 
				patientrelations_attributes: [:id, :provider_id, :patient_id, :relationtype, :patientrelationtypes_id, :_destroy, patient_attributes: [:id, :first_name, :last_name, :member_id, :_destroy]], 
